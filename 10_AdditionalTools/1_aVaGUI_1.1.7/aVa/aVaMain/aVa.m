% Neuronal Avalanches detection algorithm (aVa)
...
% The user has to set the parameters for the avalanches detection through the
% available input prompt
[binWidths,sampling_freq,cancelFlag,flagExpBin] = aVa_uigetinfo();
