...
cd (userfolder)
[matfile]=searchFolder(pwd,'Mat_files')
aFolder=matfile{1,1}
cd ..
...
%                             commonParameters=chosenParameters{1};
                            ...
                            for i=1:numFolders
                                ...
                                % output folder
                                [saveFolderName, successFlag] = createResultFolderNoUserQuestionMF(actualFolder, aFolder, 'FilteredData');
                                ...
                                outputMessage = filter_comput(actualFolder,saveSubfolderName,filterParam);
                                if ~outputMessage
